function ROE(command,varargin)
  ...
  case 'REFRESH'
    ...
    tablePosV = [.22*GUIWidth-2.5*shift posTop-.1*GUIHeight .27*GUIWidth 2.5*shift];
    ...
    'FontWeight','Bold','HorizontalAlignment','Left','backgroundColor',figColor); %Title: Model parameters
    ...
    % AI temp - hide JSON param display
    ...
    [leftMarginWidth+.1*GUIWidth shift GUIWidth-leftMarginWidth-.11*GUIWidth...

function createUIControlsROEPreset(hFig,planC,varargin)
% createUIControlsROECinical.m
% Create UI controls for the ROE interface (clinical version).
% AI 07/22/21
...
tab1ControlsH(2) = uicontrol; %Select protocols
...
tab1ControlsH(4) = uitable(hFig,'Tag','doseSel','Position',tablePosV,...
    ...
    'Data',{'Selected plan','List of plans'},'ColumnWidth',...
...
%Plot mode
tab1ControlsH(10) = uicontrol;% Only one plot mode
%plotSelH = gobjects(0);
set(tab1ControlsH(10) ,'Value',4);
...
guidata(hFig,ud);
setPlotModeROE(tab1ControlsH(10),[],hFig)

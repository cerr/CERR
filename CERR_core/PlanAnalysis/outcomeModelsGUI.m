...
switch upper(command)
    ...
    case 'INIT'
        ...
        inputH(end+1) = uicontrol(hFig,'tag','doseStatic','units','pixels',...
            ...
            defaultColor,'HorizontalAlignment','right');
        inputH(end+1) = uicontrol(hFig,'tag','doseSelect','units','pixels',...
            'Position',[150 posTop-70 120 20], 'String',doseList,'Style',...
        ...
        inputH(end+1) = uicontrol(hFig,'tag','modelFileSelect','units','pixels',...
            'Position',[20 posTop-170 180 20], 'String',...
            'Select file containing Models','Style','push', 'fontSize',8,...

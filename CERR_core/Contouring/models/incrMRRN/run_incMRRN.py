...
def main(argv):
    ...
    with open(
            '/lila/home/pandyar1/model/model_5l_lung-frrn_incremental_up_res_all_tf_drop_weight_residual_512.json') as model_file:
        model3 = models.model_from_json(model_file.read())
    print('weight test:OK')


    model3.load_weights('/lila/home/pandyar1/model/weights.15--0.71.hdf5')

function [dosesToCT3M] = get3DDoses(structNum, doseSet, planC, indexS, optS)
%function [dosesToCT3M] = get3DDoses(structNum, doseSet, planC, indexS, optS)
%This function gets doses to a subvolume of the total 3D dataset covered by the
%structure numbered structNum.  The returned 3D matrix, dosesToCT3M,
%is registered to the NONUNIFORMIZED (original) CT dataset.  A simple way to get the 'whole' dose
%distribution is to ask for the 'skin' structure dose distribution.  3-D linear interpolation
%is used (finterp.m).  This code was originally based on the code in getDVH.m.
%JOD, 19 Feb 03.
%

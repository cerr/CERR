function anonRegistrationS = defineAnonRegistration()
%
% function anonRegistrationS = defineAnonRegistration()
%
% Defines the anonymous "registration" data structure. The fields containing PHI have
...
deformS = struct(...
    'preRegTransType', 'keep', ...
    'preRegTransM', 'keep', ...
    'postRegTransType', 'keep', ...
    'postRegTransM', 'keep', ...

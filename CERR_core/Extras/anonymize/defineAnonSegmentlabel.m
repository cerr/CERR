function anonSegmentLabelS = defineAnonSegmentlabel()
%
% function anonSegmentLabelS = defineAnonSegmentlabel()
%
% Defines the anonymous "segmentLabel" data structure. The fields containing PHI have
...
indexS = struct('index','keep');
segmentS = struct('segments',indexS);

anonSegmentLabelS = struct( ...
    'name',  'keep', ...
    'labelC',  'keep', ...
    'labelColorM',  'keep', ...
    'valueS',  segmentS, ...

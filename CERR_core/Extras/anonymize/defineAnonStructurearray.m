function anonStructureArrayS = defineAnonStructurearray()
%
% function anonStructureArrayInfoS = defineAnonStructurearray()
%
% Defines the anonymous "structureArray" data structure. The fields containing PHI have

function anonStructureArrayMoreS = defineAnonStructurearraymore()
%
% function anonStructureArrayInfoS = defineAnonStructurearraymore()
%
% Defines the anonymous "structureArrayMore" data structure. The fields containing PHI have
...
anonStructureArrayMoreS = struct( ...
'indicesArray', 'keep', ...
'bitsArray', 'keep', ...
'assocScanUID', 'keep', ....
'structureSetUID', 'keep' ...
);

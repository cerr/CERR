function COMSI = calc_comsi(structNum,doseNum,lungIndex,planC)
%function COMSI = calc_comsi(structNum,doseNum,planC)
%
%This function returns the COMSI for input structure and dose
%
%APA, 04/16/2007
%

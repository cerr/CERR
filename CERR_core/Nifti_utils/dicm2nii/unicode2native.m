...
%!testif HAVE_ICONV
%! assert (unicode2native ("Ð„Ð…Ð†Ð‡ÐÐ‰ÐŠ", "ISO-8859-5"), uint8 (164:170));
%!testif HAVE_ICONV
%! assert (unicode2native (["Ð„Ð…Ð†" "\0" "Ð‡ÐÐ‰ÐŠ"], "ISO-8859-5"),
...
%!error <CODEPAGE must be a string> unicode2native ('Ð„Ð…Ð†Ð‡ÐÐ‰ÐŠ', 123)
%!error <CODEPAGE must be a string> unicode2native ('Ð„Ð…Ð†Ð‡ÐÐ‰ÐŠ', ['ISO-8859-1']')
%!testif HAVE_ICONV

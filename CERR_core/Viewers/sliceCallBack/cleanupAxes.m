...
for i=1:length(hAxisV)
    ...
    if ~strcmpi(view, 'Legend')
        ...
        allHandles = [allHandles stateS.handle.rulerLine',stateS.handle.doseQueryPoint',...
            ...
            stateS.handle.CERRAxisScreenLeftLabel, stateS.handle.CERRAxisScreenRightLabel, ...
            stateS.handle.CERRAxisScreenTopLabel, stateS.handle.CERRAxisScreenBottomLabel];
        toRemove = [];

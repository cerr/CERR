...
% Get physical (x,y,z) coordinates (in mm) of scanNum in DICOM LPS
% from deformation vector field in image coordinates.
%
...
indexS = planC{end};
basePositionMatrix = planC{indexS.scan}(scanNum).Image2PhysicalTransM * 10;   
...
for slc = 1:baseSizV(3)
    ...
    dvfM = [rowDeformM(:), colDeformM(:), slcDeformM(:),onesV];

...
# Usage: python run_seg_cm_ax.py [parameter_dictionary] [path to folder containing input 2D h5 files]
...
class Trainer(object):
    def __init__(self, argv):
        ...
        #modelPath = os.path.join(modelDir, 'finalModels/CM_Ax_model.pth.tar')
        modelPath = '/software/models/CM_Ax_model.pth.tar'
    ...
    def transform_ts(self, sample):
        ...
        composed_transforms = transforms.Compose([
            ...
            tr.Normalize(mean=(0.3516, 0.3516, 0.3516), std=(0.2203, 0.2203, 0.2203)),
            tr.ToTensor()])

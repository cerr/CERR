...
# Usage: python run_seg_mm_pm_ax.py [parameter_dictionary] [path to folder containing input 2D H5 files]
...
class Trainer(object):
    def __init__(self, argv):
        ...
        #modelPath = os.path.join(modelDir, 'finalModels/MM_PM_Ax_model.pth.tar')
        modelPath = '/software/models/MM_PM_Ax_model.pth.tar'
    ...
    def validation(self, inputH5Path):
        ...
        count = 0
        # loop over the h5 files adn return computed probability maps
        for filename in files:
            ...
            # standardize and convert to tensor
    ...
    def transform_ts(self, sample):
        ...
        composed_transforms = transforms.Compose([
            ...
            tr.Normalize(mean=(0.2306, 0.2306, 0.2306), std=(0.2093, 0.2093, 0.2093)),
            tr.ToTensor()])

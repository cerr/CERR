...
# Usage: python run_seg_mm_pm_sag.py [parameter_dictionary] [path to folder containing input 2D h5 files]
...
class Trainer(object):
    ...
    def transform_ts(self, sample):
        ...
        composed_transforms = transforms.Compose([
            ...
            tr.Normalize(mean=(0.2412, 0.2412, 0.2412), std=(0.1943, 0.1943, 0.1943)),
            tr.ToTensor()])

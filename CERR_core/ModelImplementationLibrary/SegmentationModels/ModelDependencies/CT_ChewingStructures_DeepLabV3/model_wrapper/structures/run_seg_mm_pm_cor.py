...
# Date: Oct 10, 2019
# Description: Script to segment masseters (left and right) nad medial pterygoids (left and right) from coronal CT images
# Architecture :  Deeplab v3+ with resnet backbone
# Usage: python run_seg_mm_pm_cor.py [parameter_dictionary] [path to folder containing input 2D h5 files]
...
class Trainer(object):
    def __init__(self, argv):
        ...
        #modelPath = os.path.join(modelDir, 'finalModels/MM_PM_Cor_model.pth.tar')
        modelPath = '/software/models/MM_PM_Cor_model.pth.tar'
    ...
    def validation(self, inputH5Path):
        ...
        print('Computing probability maps (coronal view )....')
        count = 0
        ...
        for filename in files:
            ...
            # standardize and converting to tensor
    ...
    def transform_ts(self, sample):
        ...
        composed_transforms = transforms.Compose([
            ...
            tr.Normalize(mean=(0.2663, 0.2663, 0.2663), std=(0.2081, 0.2081, 0.2081)),
            tr.ToTensor()])

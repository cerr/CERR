...
# Usage: python run_seg_larynx_sag.py [parameter_dictionary][path to folder containing input 2D h5 files]
...
class Trainer(object):
    def __init__(self, argv):
        ...
        #modelPath = os.path.join(modelDir, 'finalModels/Larynx_Sag_model.pth.tar')
        modelPath = '/software/models/Larynx_Sag_model.pth.tar'
    ...
    def validation(self, inputH5Path):
        ...
        print('Computing probability maps (sag view)...')
        count = 0
    ...
    def transform_ts(self, sample):
        ...
        composed_transforms = transforms.Compose([
            ...
            tr.Normalize(mean=(0.3157, 0.3157, 0.3157), std=(0.1803, 0.1803, 0.1803)),
            tr.ToTensor()])

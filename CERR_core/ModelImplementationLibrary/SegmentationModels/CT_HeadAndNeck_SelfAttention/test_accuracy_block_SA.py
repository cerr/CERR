...
def main(argv):
    ...
    for filename in files:
        ...
        val_label_ct=np.array(val_data_ct.shape)

        val_data_ct=normalize_data(val_data_ct)
        images_ct_val=np.concatenate((val_data_ct, val_label_ct), 1)
        ...
        weight_read_path = '/software/headAndNeckModels/model_save_net_Seg_A.pth'

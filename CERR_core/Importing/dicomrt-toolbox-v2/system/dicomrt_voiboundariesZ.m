function [locate_voi_min_1,locate_voi_max_1,locate_voi_min_2,locate_voi_max_2] = dicomrt_voiboundariesZ(slice,voiref,dose_1mesh,dose_2mesh,VOI,voi2use,PatientPosition)
% dicomrt_voiboundariesZ(slice,voiref,dose_1mesh,dose_2mesh,VOI,voi2use,PatientPosition)
%
...
elseif PatientPosition==4
    ...
    error('dicomrt_voiboundariesZ: Unable to parse PatientPosition. Exit now!');
end
function dataS = populate_planC_dose_field(fieldname, dcmdir_PATIENT_STUDY_SERIES_RTDOSE, attr, rtPlans)
...
%         end
    ...
    case 'assocScanUID'
        ...
        %dataS = char(attr.getString(org.dcm4che2.data.Tag.FrameofReferenceUID));

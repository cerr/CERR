function tagS = patient_module_tags_subset
%"patient_module_tags_subset"
%   Return a subset of the tags specified in C.7.1.1 in PS3.3 of the
%   2006 DICOM specification required for distinguishing patients.
%

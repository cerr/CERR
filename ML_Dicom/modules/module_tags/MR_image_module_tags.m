...
%Laterality
tagS(end+1) = struct('tag', '00200060', 'tagdec', 2097248, 'type', '2C', 'children', []);

%Series Date
tagS(end+1) = struct('tag', '00080021', 'tagdec', 524321, 'type', '3', 'children', []);

%Series Time
tagS(end+1) = struct('tag', '00080031', 'tagdec', 524337, 'type', '3', 'children', []);

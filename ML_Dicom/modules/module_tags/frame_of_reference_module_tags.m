function tagS = frame_of_reference_module_tags
%"frame_of_reference_module_tags"
%   Return the tags used to represent a frame of reference as specified by 
%   C.7.4.1 in PS3.3 of 2006 DICOM specification.
%

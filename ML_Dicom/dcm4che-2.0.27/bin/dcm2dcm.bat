...
set MAIN_JAR=dcm4che-tool-dcm2dcm-2.0.27.jar
...
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-image-2.0.27.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-imageio-2.0.27.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-imageio-rle-2.0.27.jar

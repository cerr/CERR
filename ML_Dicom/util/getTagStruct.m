...
tagS = attr.tags();
emptJavaStr = javaObject("java.lang.String",'');
for i=1:length(tagS)
    ...
    %name = name{1};
    name = javaMethod("keywordOf","org.dcm4che3.data.ElementDictionary",...
    tag,emptJavaStr);
    ...
    if javaMethod("isPrivateCreator","org.dcm4che3.util.TagUtils",tag)
        ...
        tagString  = javaMethod("toString","org.dcm4che3.util.TagUtils",tag);

function IMCalc = beam2MCdose(leak, spectrum_File, planC_File, nhist, OutputError, whichBeam, PBMaxWidth, gradsense, MCsolver, saveIM, sourceModel, doseToWater, fillWater, useWedge, inputPB, inputIM, Softening, UseFlatFilter, MLC, TongueGroove, batch, priOptMode, LS_flag, K, scatterThreshold)
% written by KZ, JC
...
if (~isempty(planC{indexS.beams}) & (planC{indexS.beams}(1).FractionGroupSequence.Item_1.NumberOfBeams))

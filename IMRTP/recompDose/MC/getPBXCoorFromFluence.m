function [PBXPoints rowLeafPositions ] = getPBXCoorFromFluence(inflMap, rowLeafPositions, minPBX, PBMaxWidth, colXDivider, rowYDivider, gradsense, MLC);

% LM: JC Sept 19, 2007
% Add MLC modeling part.
if (MLC == 1)
[newFluenceMap rowLeafPositions] = mergeFluenceMap(inflMap, rowLeafPositions, 1);

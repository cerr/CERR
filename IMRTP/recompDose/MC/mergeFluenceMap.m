...
% The display scheme here is problematic. To be worked on. 
        patch([xL(1) xL(1) xL(2) xL(2) xL(1)], [y-newFluenceMap(i).width y y y-newFluenceMap(i).width y-newFluenceMap(i).width], newFluenceMap(i).intensity(j));
    end
end

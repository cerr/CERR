function [RTOGPBVectorsM, RTOGPBVectorsM_MC, PBMaskM, rowPBV, colPBV, xPosV, yPosV, beamlet_delta_x, beamlet_delta_y] = getPBRays(xPosV, yPosV, beamlet_delta_x, beamlet_delta_y, sourceS)

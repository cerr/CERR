function DPMpcStandAlongJingOneBeam3(leak, spectrum_File, planC_File, nhist, OutputError, whichBeam, PBMaxWidth, gradsense, scatterThreshold, batch)
% written by KZ, JC
...
for indexBeam = whichBeam
    ...
    if (bf.BeamDose ~= 0)
        ...
        [PBX] = getPBXCoorFromFluence(inflMap, rowLeafPositions, 2, PBMaxWidth, colDividerXCoord, rowDividerYCoord, gradsense);

function DPMpcStandAlongJing(leak, spectrum_File, planC_File, nhist, OutputError)
% written by KZ
% Calculate IM struct, call DPM, get
% JC Feb 27 06
% Use sum(10*clock) as the random seeds in DPMInfluenceJing.m
% Change the MaxPBwidth == 20; gradsense = 26; for LungCCC case.
%
...
%for indexBeam = 1 : 4
    ...
    if (bf.BeamDose ~= 0)
        ...
        [PBX] = getPBXCoorFromFluence(inflMap, rowLeafPositions, 2, 20, colDividerXCoord, rowDividerYCoord, 26);
